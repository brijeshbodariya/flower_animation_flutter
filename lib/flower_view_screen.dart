...
import 'package:flower_animation_flutter/const/ui_const.dart';
import 'package:flower_animation_flutter/model/local_model/homepage_view_model.dart';
...
class FlowerViewScreen extends StatefulWidget {
  ...
  const FlowerViewScreen({Key? key, this.index, this.photo}) : super(key: key);
...
class _FlowerViewScreenState extends State<FlowerViewScreen> {
  ...
  var animationDuration = const Duration(microseconds: 0);
            ...
            children: <Widget>[
              ...
              Hero(
                ...
                child: Container(
                  ...
                  child: textViewFlower(
                      "Bouquet of ${HomePageViewModel().flowerList[widget.index!].name}",
                      1.0,
                      0.0),
                ),
              ),
              ...
              Container(
                margin: const EdgeInsets.only(left: 10, right: 0, bottom: 22),
  ...
  textViewFlower(s, wordSpacing, lineSpace) => AnimatedContainer(
        ...
        margin: EdgeInsets.only(
            top: flowerDescriptionTextAnimation, left: 10, bottom: 0, right: 0),
        child: Text(s,
  ...
  textView() => Container(
        alignment: Alignment.topLeft,
        margin: const EdgeInsets.only(top: 7, left: 18, bottom: 7),
  ...
  plantsQuantityViewPrice() => Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              margin: const EdgeInsets.only(right: 30, left: 27),
              child: Row(
                ...
                children: <Widget>[
                  ...
                  const Spacer(),
                  Text(
                      "${_homePageViewModel.flowerList[widget.index!].quantity} flowers",
                      style: GoogleFonts.roboto(
                        fontStyle: FontStyle.normal,
                        color: Colors.black,
                        fontWeight: FontWeight.bold,
        ...
        child: Wrap(
          children: <Widget>[
            InkWell(
              ...
              child: itemView(_homePageViewModel.flowerList[0].itemUrl!,
                  _homePageViewModel.flowerList[0].item!),
            ),
            itemView(_homePageViewModel.flowerList[1].itemUrl!,
                _homePageViewModel.flowerList[1].item!),
            itemView(_homePageViewModel.flowerList[2].itemUrl!,
                _homePageViewModel.flowerList[2].item!),
            itemView(_homePageViewModel.flowerList[3].itemUrl!,
                _homePageViewModel.flowerList[3].item!),
            itemView(_homePageViewModel.flowerList[4].itemUrl!,
                _homePageViewModel.flowerList[4].item!),
            Container(
              height: 90,
              width: 90,
  ...
  itemView(String s, String t) => Container(
        margin: const EdgeInsets.only(left: 15, bottom: 10, top: 10, right: 10),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
...
//    });
  ...
  List<Widget> _iconViews() {
    ...
    widget._icons!.asMap().forEach((i, icon) {
      ...
      var lineColor =
          widget._curStep > i + 1 ? widget._activeColor : _inactiveColor;

      // Color iconColor = (i == 0 || widget._curStep > i + 1)
      //     ? _inactiveColor
      //     : widget._activeColor;
